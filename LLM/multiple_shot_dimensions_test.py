...
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_zero_shot_dimensions.csv', index=False)
...
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_one_shot_dimensions.csv', index=False)
...
# save
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_two_shot_dimensions.csv', index=False)
...
# save
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_three_shot_dimensions.csv', index=False)
...
# save
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_four_shot_four_points_dimensions.csv', index=False)
...
# save
test_set.to_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_five_shot_five_points_dimensions.csv', index=False)
...
print('zero shot')
# load
zero_shot = pd.read_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_zero_shot_dimensions.csv')
left_zero = check_correlation(zero_shot)

print('one shot')
# load
one_shot = pd.read_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_one_shot_dimensions.csv')
...
print('three shot')
# load
three_shot = pd.read_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_three_shot_dimensions.csv')
left_three = check_correlation(three_shot)


print('four shot four points')
# load
four_shot_four_points = pd.read_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_four_shot_four_points_dimensions.csv')
left_four_points = check_correlation(four_shot_four_points)

print('five shot five points')
# load
five_shot_five_points = pd.read_csv('data/for_training/test_set_llm_gpt3_5_turbo_0125_five_shot_five_points_dimensions.csv')
...
correlation_df.to_csv('data/for_training/results_dimensions_test.csv', index=False)

# load
correlation_df = pd.read_csv('data/for_training/results_dimensions_test.csv')
