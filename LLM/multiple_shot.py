...
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_zero_shot_val.csv', index=False)
...
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_one_shot_val.csv', index=False)
...
# save
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_two_shot_val.csv', index=False)
...
# save
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_three_shot_val.csv', index=False)
...
print('Four shot')
four_shot = pd.read_csv('data/embeddings/four_shot.csv')
val_set = pd.read_csv('data/for_training/new_training_data/val_set.csv')
for emotion, emotion_column in zip(emotions, emotion_columns):
    print(emotion)
...
# save
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_four_shot_val.csv', index=False)
...
# save
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_four_shot_four_points_val.csv', index=False)
...
# save
val_set.to_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_five_shot_five_points_val.csv', index=False)
...
print('zero shot')
# load
zero_shot = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_zero_shot_val.csv')
left_zero = check_correlation(zero_shot)

print('one shot')
# load
one_shot = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_one_shot_val.csv')
left_one = check_correlation(one_shot)

print('two shot')
# load
two_shot = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_two_shot_val.csv')
left_two = check_correlation(two_shot)

print('three shot')
# load
three_shot = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_three_shot_val.csv')
left_three = check_correlation(three_shot)

print('four shot')
# load
four_shot = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_four_shot_val.csv')
left_four = check_correlation(four_shot)

print('four shot four points')
# load
four_shot_four_points = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_four_shot_four_points_val.csv')
left_four_points = check_correlation(four_shot_four_points)

print('five shot five points')
# load
five_shot_five_points = pd.read_csv('data/for_training/val_set_llm_gpt3_5_turbo_0125_five_shot_five_points_val.csv')
left_five_points = check_correlation(five_shot_five_points)



types = ['zero_shot', 'one_shot', 'two_shot', 'three_shot', 'four_shot', 'four_shot_four_points', 'five_shot_five_points']
correlation_list = []
standard_deviation_list = []
for type, shot in zip(types, [zero_shot, one_shot, two_shot, three_shot, four_shot, four_shot_four_points, five_shot_five_points]):
...
correlation_df.to_csv('data/for_training/results.csv', index=False)




# load
correlation_df = pd.read_csv('data/for_training/results.csv')
